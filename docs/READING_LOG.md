...
- e116 · [CIS Archive No.1 2006] 1968: historical charts produced on a set 7- or 8-day interval, end-of-season specifically for climatology → points to the "Historical dates" of CIS climatological methodology. → DEC-027 #chart-preparation #cross-era-normalization
- e117 · [CIS Archive No.1 2006] Historical charts discontinued in 1974; they carried better shoulder-season (start/end) information than regional charts (often not produced until the ice season was underway). → DEC-027 #chart-preparation #open-question
