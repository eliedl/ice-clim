...
| 006 | SGRDA `POLY_TYPE='L'` vs `global_coastline.shp` — geometric agreement across all archive years (2006–2026) to validate the static reference shapefile as a substitute for DB-derived land polygons in the climatology pipeline | **complete** 2026-05-28 — see `006_sgrda_l_vs_global_coastline/README.md` Outcome. Surfaced 3 CIS digitization eras (2006–07, 2008–23, 2024–26); our climatology period sits entirely in the stable mid-era with floating-point agreement. |